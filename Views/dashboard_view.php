...
<div style="width:100%; background-color:#eee; text-align:right; padding:2px;">
...
<div style="text-align:center; width:100%;">
  <div style="width: 960px; margin: 0px auto; padding:0px; text-align:left; margin-bottom:20px; margin-top:5px;">
    <div id="tabs">
      <ul>
        <li>
          <a href="#tabs-1"><?php echo _("Edit dashboard"); ?></a>
        </li>
        <li>
          <a href="#tabs-2"><?php echo _("Configuration"); ?></a>
        </li>
        <li>
          <a href="#tabs-3"><?php echo _("Preview"); ?></a>
        </li>
      </ul>
      <div id="tabs-1">
