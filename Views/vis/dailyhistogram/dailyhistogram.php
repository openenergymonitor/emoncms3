<html>
  ...
  <div style="margin-top:20px; margin-right:3%; margin-left:3%;">
    ...
    <div id="test" style="height:500px; width:100%; position:relative; ">
      ...
      <div style="position:absolute; top:10px; left:65px; font-size:18px;">
        <b><span id="out2"></span></b><span style="font-size:12px;"> (Hover for info, press to zoom in. Histogram:
