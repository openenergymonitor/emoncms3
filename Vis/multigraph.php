<html>
  ...
  $feedid = $_GET["feedid"];
  //Get the table ID so that we know what graph to draw
  ...
  <body style="font-family:arial;">
    ...
    <div style="text-align:right;">
      <span id="date"></span>
      | Last:
      <button class="timewindow" time="1440" >
        <?php echo _("2 Months"); ?>
      </button>
      <button class="timewindow" time="720" >
        <?php echo _("Month"); ?>
      </button>
      <button class="timewindow" time="168" >
        <?php echo _("Week"); ?>
      </button>
      <button class="timewindow" time="24" >
        <?php echo _("Day"); ?>
      </button>
      <button class="timewindow" time="1" >
        <?php echo _("Hour"); ?>
      </button>
      <button class="zoomin" >
        +
    ...
    <div id="graph_bound" style="height:100%; width:100%; position:relative; ">
      <div id="placeholder" style="float: left;"></div>
      <br/ >
        <div id="choices" style="float:left; background-color:#eee; width:100%; padding:10px;"></div>
    </div>
    ...
    <script id="source" language="javascript" type="text/javascript">
      ...
      <?php echo $plot_style; ?>
        ...
        dataType: 'json',
        async: false,
        success: function(data) { feedin = data; }
        });
        //-------------------------------------------------
        var feedlist = [];
        ...
        var out = "<table border='0'><tr><th>"+
      <?php echo _("Select Feeds"); ?>+
      "</th><th width=60px>"+<?php echo _("Left vs"); ?>+
      "</th><th>"+<?php echo _("Right"); ?>+
      "</th></tr>";
      ...
      out += "</table>";
      out += "<p style='font-size:12px'><i>"+<?php echo _("Loading a feed can take time.. "); ?>+
      "</i></p>";
      out += "<p style='font-size:12px'><i>"+<?php echo _("Load feed on the left for fill and right for line only"); ?>
        +</i></p>";
