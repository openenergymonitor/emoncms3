...
<?php echo $apikey; ?>
  ...
  $('#loading').show();
  $("#stat").html(
<?php echo _("Loading...  please wait about 5s"); ?>
  );
  $.ajax(
  {
    ...
    success : function(data)
    {
      ...
      //Initial time window
      start = ((new Date()).getTime()) - timeWindow;
      //Get start time
  ...
  placeholder.bind("plotselected", function(event, ranges)
  {
    ...
    //covert into usable time values
    end = ranges.xaxis.to;
    //covert into usable time values
    plotGraph(start, end);
  });
  ...
  $('.time').click(function()
  {
    ...
    //Get timewindow from button
    start = ((new Date()).getTime()) - (3600000 * 24 * time);
    //Get start time
