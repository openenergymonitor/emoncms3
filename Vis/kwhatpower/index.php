...
-------------------------------------------------------------------------------------->
 ...
 <?php
  ...
  $path = dirname("http://".$_SERVER['HTTP_HOST'].str_replace('Vis/kwhatpower', '', $_SERVER['SCRIPT_NAME']))."/";
 ...
 <body style="font-family:arial">
   ...
   var rmin = "<?php echo $min; ?>";
   var rmax = "<?php echo $max; ?>"; 
   ...
   $(function () {
     ...
     vis_feed_data(apikey,feedid,rmin,rmax);
...
grid: { show: true, hoverable: true },
     ...
     // Fetch Data
     //--------------------------------------------------------------------------------------
     function vis_feed_data(apikey,feedid,rmin,rmax)
     {
       $('#loading').show();
