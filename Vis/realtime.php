  ...
  <body style="font-family:arial">
    ...
    <div id="graph_bound" style="height:100%; width:100%; position:relative; ">
      ...
      <div style="position:absolute; top:20px; right:20px;">
        <button class="viewWindow" time="24">
          <?php echo _("1 day"); ?>
        </button>
        <button class="viewWindow" time="12">
          <?php echo _("12 hours"); ?>
        </button>
    ...
    <div class="inc" style="font-size: 10px;"></div>
    <!-- Refresh counter placeholder -->
    <div id="stat" style="font-size: 20px; font-family: arial;  font-weight: normal; color: #333;">
      ---
    </div>
