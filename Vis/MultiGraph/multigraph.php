      ...
      out += "<p style='font-size:12px'><i>"+<?php echo _("Loading a feed can take time.. "); ?>
        ...
        choiceContainer.find("input[type='checkbox']").click(function()
        {
          ...
          if (axis == 1 && checked == true)
            choiceContainer.find("input[id='" + id + "'][axis='2']").removeAttr("checked");
          if (axis == 2 && checked == true)
            choiceContainer.find("input[id='" + id + "'][axis='1']").removeAttr("checked");
          ...
          for (var i in feedlist)
          {
            ...
            {
              feedlist[i].selected = Number(axis);
              feedlist[i].data.yaxis = Number(axis);
            }
